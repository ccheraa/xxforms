...
// workaround for xforms-viewBox attribute
document.querySelectorAll('svg').forEach(svg => {
  svg.setAttribute('xf-template-viewBox', svg.getAttribute('xf-template-viewbox'));
  svg.removeAttribute('xf-template-viewbox');
});
...
function XsltForms_load(subform, elt) {
  ...
  if (elt.hasAttribute("xf-resource")) {
  ...
  } else if (elt.hasAttribute("xf-template-resource")) {
    this.resource = new XsltForms_binding(this.subform, elt, "xf-template-resource", "xsd:string");
    ...
    } else if (elt.children[0].hasAttribute("xf-template-value")) {
      this.resource = new XsltForms_binding(this.subform, elt.children[0], "xf-template-value", "xsd:string");
    } else {
